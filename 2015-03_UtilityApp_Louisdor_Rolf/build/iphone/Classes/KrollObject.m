...
//@interface k2015_03_UtilityApp_Louisdor_RolfObject : NSObject
//@end

@interface k2015_03_UtilityApp_Louisdor_RolfObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[k2015_03_UtilityApp_Louisdor_RolfObject class]])
		{
			for (NSString *key in [[(k2015_03_UtilityApp_Louisdor_RolfObject*)o modules] allKeys])
			{
