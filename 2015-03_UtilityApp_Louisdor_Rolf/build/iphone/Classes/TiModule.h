...
/**
 The base class for all k2015_03_UtilityApp_Louisdor_Rolf modules
 */
...
/**
 k2015_03_UtilityApp_Louisdor_Rolf Platform calls this method on startup.
 */
-(void)startup;

/**
 k2015_03_UtilityApp_Louisdor_Rolf Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 k2015_03_UtilityApp_Louisdor_Rolf Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 k2015_03_UtilityApp_Louisdor_Rolf Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 k2015_03_UtilityApp_Louisdor_Rolf Platform calls this method on resume.
 @param sender The sender of the event.
 */
