...
-(void)request:(APSHTTPRequest *)request onLoad:(APSHTTPResponse *)response
{
	...
	if ([req cancelled]==NO)
	{
		...
		if (data == nil || [data length]==0)
		{
			...
			NSError *error = [NSError errorWithDomain:@"com.k2015_03_utilityapp_louisdor_rolf._k2015_03_utilityapp_louisdor_rolf.imageloader" code:1 userInfo:errorDetail];
