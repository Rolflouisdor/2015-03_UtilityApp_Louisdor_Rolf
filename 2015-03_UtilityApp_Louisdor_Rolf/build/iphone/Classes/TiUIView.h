...
/**
 Base class for all k2015_03_UtilityApp_Louisdor_Rolf views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the k2015_03_UtilityApp_Louisdor_Rolf view hierarchy (such as wrapped iOS UIViews) was touched.
