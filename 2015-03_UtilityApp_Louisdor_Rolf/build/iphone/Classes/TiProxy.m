...
//Rare exceptions to indicate a bug in the _k2015_03_utilityapp_louisdor_rolf code (Eg, method that a subclass should have implemented)
...
+ (id)createProxy:(NSString*)qualifiedName withProperties:(NSDictionary*)properties inContext:(id<TiEvaluator>)context
{
	...
	if (proxyClass == nil) {
		NSString *_k2015_03_utilityapp_louisdor_rolf = [NSString stringWithFormat:@"%@%s",@"Ti","tanium."];
		if ([qualifiedName hasPrefix:_k2015_03_utilityapp_louisdor_rolf]) {
		...
		if (proxyClass==nil) {
			...
			@throw [NSException exceptionWithName:@"org.k2015_03_utilityapp_louisdor_rolf.module"
