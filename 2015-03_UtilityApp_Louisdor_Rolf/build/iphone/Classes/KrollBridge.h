...
@interface k2015_03_UtilityApp_Louisdor_RolfObject : KrollCoverageObject {
#else
@interface k2015_03_UtilityApp_Louisdor_RolfObject : KrollObject {
#endif
@private
...
extern NSString * k2015_03_UtilityApp_Louisdor_Rolf$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k2015_03_UtilityApp_Louisdor_RolfObject *_k2015_03_utilityapp_louisdor_rolf;
    KrollObject* console;
	BOOL shutdown;
